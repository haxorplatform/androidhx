...
public  class StringRefl
{
	...
	{
		{
			java.lang.String __temp_svar50 = (f);
			int __temp_hash52 = __temp_svar50.hashCode();
			boolean __temp_executeDef51 = true;
			switch (__temp_hash52)
			{
				case -1106363674:
				{
					if (__temp_svar50.equals("length")) 
					{
				...
				{
					if (( (( ( __temp_hash52 == 530542161 ) && __temp_svar50.equals("substring") )) || ( (( ( __temp_hash52 == -891529231 ) && __temp_svar50.equals("substr") )) || ( (( ( __temp_hash52 == 109648666 ) && __temp_svar50.equals("split") )) || ( (( ( __temp_hash52 == -467511597 ) && __temp_svar50.equals("lastIndexOf") )) || ( (( ( __temp_hash52 == 1943291465 ) && __temp_svar50.equals("indexOf") )) || ( (( ( __temp_hash52 == 397153782 ) && __temp_svar50.equals("charCodeAt") )) || ( (( ( __temp_hash52 == -1361633751 ) && __temp_svar50.equals("charAt") )) || ( (( ( __temp_hash52 == -1137582698 ) && __temp_svar50.equals("toLowerCase") )) || __temp_svar50.equals("toUpperCase") ) ) ) ) ) ) ) )) 
					{
						__temp_executeDef51 = false;
