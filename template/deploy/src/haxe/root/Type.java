...
public  class Type extends haxe.lang.HxObject
{
	...
	public static   java.lang.String getClassName(java.lang.Class c)
	{
		...
		{
			java.lang.String __temp_svar31 = (name);
			int __temp_hash33 = __temp_svar31.hashCode();
			boolean __temp_executeDef32 = true;
			switch (__temp_hash33)
			{
				case -672261858:case 104431:
				{
					if (( (( ( __temp_hash33 == -672261858 ) && __temp_svar31.equals("Integer") )) || __temp_svar31.equals("int") )) 
					{
				...
				case -1939501217:
				{
					if (__temp_svar31.equals("Object")) 
					{
						__temp_executeDef32 = false;
						return "Dynamic";
					}
				...
				{
					if (( (( ( __temp_hash33 == 2052876273 ) && __temp_svar31.equals("Double") )) || __temp_svar31.equals("double") )) 
					{
						__temp_executeDef32 = false;
						return "Float";
					}
