...
public final class ArrayIterator<T> extends haxe.lang.HxObject
{
	...
	public static  <T_c> void __hx_ctor__Array_ArrayIterator(_Array.ArrayIterator<T_c> __temp_me3255, haxe.root.Array<T_c> a)
	{
		__temp_me3255.arr = a;
		__temp_me3255.len = a.length;
		__temp_me3255.i = 0;
	}
	...
	{
		{
			boolean __temp_executeDef3274 = true;
	...
	{
		{
			boolean __temp_executeDef3275 = true;
			switch (field.hashCode())
			{
				case 105:
				{
	...
	{
		{
			boolean __temp_executeDef3276 = true;
			switch (field.hashCode())
			{
				case 3377907:
				{
	...
	{
		{
			boolean __temp_executeDef3277 = true;
			switch (field.hashCode())
			{
				case 105:
				{
	...
	{
		{
			boolean __temp_executeDef3278 = true;
			switch (field.hashCode())
			{
				case 3377907:
				{
