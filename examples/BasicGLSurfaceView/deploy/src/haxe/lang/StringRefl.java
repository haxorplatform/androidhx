...
public  class StringRefl
{
	...
	{
		{
			java.lang.String __temp_svar3315 = (f);
			int __temp_hash3317 = __temp_svar3315.hashCode();
			boolean __temp_executeDef3316 = true;
			switch (__temp_hash3317)
			{
				case -1106363674:
				{
					if (__temp_svar3315.equals("length")) 
					{
						__temp_executeDef3316 = false;
						return str.length();
					}
				...
				{
					if (( (( ( __temp_hash3317 == 530542161 ) && __temp_svar3315.equals("substring") )) || ( (( ( __temp_hash3317 == -891529231 ) && __temp_svar3315.equals("substr") )) || ( (( ( __temp_hash3317 == 109648666 ) && __temp_svar3315.equals("split") )) || ( (( ( __temp_hash3317 == -467511597 ) && __temp_svar3315.equals("lastIndexOf") )) || ( (( ( __temp_hash3317 == 1943291465 ) && __temp_svar3315.equals("indexOf") )) || ( (( ( __temp_hash3317 == 397153782 ) && __temp_svar3315.equals("charCodeAt") )) || ( (( ( __temp_hash3317 == -1361633751 ) && __temp_svar3315.equals("charAt") )) || ( (( ( __temp_hash3317 == -1137582698 ) && __temp_svar3315.equals("toLowerCase") )) || __temp_svar3315.equals("toUpperCase") ) ) ) ) ) ) ) )) 
					{
						__temp_executeDef3316 = false;
