...
public  class Type extends haxe.lang.HxObject
{
	...
	public static   void __hx_ctor__Type(haxe.root.Type __temp_me3258)
	{
		{
		}
	...
	public static   java.lang.String getClassName(java.lang.Class c)
	{
		...
		{
			java.lang.String __temp_svar3285 = (name);
			int __temp_hash3287 = __temp_svar3285.hashCode();
			boolean __temp_executeDef3286 = true;
			switch (__temp_hash3287)
			{
				case -672261858:case 104431:
				{
					if (( (( ( __temp_hash3287 == -672261858 ) && __temp_svar3285.equals("Integer") )) || __temp_svar3285.equals("int") )) 
					{
						__temp_executeDef3286 = false;
						return "Int";
					}
				...
				case -1939501217:
				{
					if (__temp_svar3285.equals("Object")) 
					{
						__temp_executeDef3286 = false;
						return "Dynamic";
					}
				...
				{
					if (( (( ( __temp_hash3287 == 2052876273 ) && __temp_svar3285.equals("Double") )) || __temp_svar3285.equals("double") )) 
					{
						__temp_executeDef3286 = false;
						return "Float";
					}
