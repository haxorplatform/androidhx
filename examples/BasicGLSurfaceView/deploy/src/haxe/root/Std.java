...
public  class Std
{
	...
	public static   boolean is(java.lang.Object v, java.lang.Object t)
	{
		...
		{
			java.lang.String __temp_svar3279 = (name);
			int __temp_hash3281 = __temp_svar3279.hashCode();
			switch (__temp_hash3281)
			{
				case 761287205:case -1325958191:
				{
					if (( (( ( __temp_hash3281 == 761287205 ) && __temp_svar3279.equals("java.lang.Double") )) || __temp_svar3279.equals("double") )) 
					{
				...
				case 1063877011:
				{
					if (__temp_svar3279.equals("java.lang.Object")) 
					{
						return true;
					}
				...
				{
					if (( (( ( __temp_hash3281 == -2056817302 ) && __temp_svar3279.equals("java.lang.Integer") )) || __temp_svar3279.equals("int") )) 
					{
				...
				{
					if (( (( ( __temp_hash3281 == 344809556 ) && __temp_svar3279.equals("java.lang.Boolean") )) || __temp_svar3279.equals("boolean") )) 
					{
